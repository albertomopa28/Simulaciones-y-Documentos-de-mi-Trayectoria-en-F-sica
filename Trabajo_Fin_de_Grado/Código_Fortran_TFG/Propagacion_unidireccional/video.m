...
speed_factor = 1;                  % Factor de velocidad del video
...
video_EH = VideoWriter('evolucion_EH_uni.avi');
...
x_min = min(x_vals);
x_max = max(x_vals);
E_max = 1.1*max(E_vals); % Amplitud máxima para E (basado en tu especificación)
