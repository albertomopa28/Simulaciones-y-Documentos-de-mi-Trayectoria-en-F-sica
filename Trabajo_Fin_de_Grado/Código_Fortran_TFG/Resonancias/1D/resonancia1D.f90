...
real :: gammax=-1, gammay, gammaz            !Coeficientes de reflexion alimenta V6 y se trata de modo TM
real :: e0=1.                                   !amplitud del pulsoS
integer :: Inx=27, Iny=1, Inz=1                  !Punto de excitacion
integer :: Ox1=50, Oy1=1, Oz1=1               !Punto de salida
integer :: Ox2=250, Oy2=1, Oz2=1               !Punto de salida
...
open(1,file='salidas1D.txt')
open(2,file='freqs1D.txt')
open(3,file='datos1D.txt')
open(4, file='salidas2puntos.txt')
...
write(4, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt, &  !Para no perder precision usar formato cientifico
    Ey(Ox1, Oy1, Oz1), Hz(Ox1, Oy1, Oz1), Ey(Ox2, Oy2, Oz2), Hz(Ox2, Oy2, Oz2)
