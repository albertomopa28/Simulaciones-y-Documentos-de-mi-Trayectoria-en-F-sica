...
parameter (imax= 20, jmax= 25, kmax= 30)        !Dimensiones maximas de la red
Parameter (nits=100000)                          !Numero de iteraciones temporales
...
real :: gammax=-1, gammay=-1, gammaz=-1         !Coeficientes de reflexion alimenta V6 y se trata de modo TM
real :: e0=1.                                   !amplitud del pulso
integer :: Inx=3, Iny=7, Inz=11                  !Punto de excitacion
integer :: Ox1=13, Oy1=9, Oz1=17               !Punto de salida
...
integer o_inicial, p_inicial, q_inicial
...
open(1,file='salidas3D.txt')
open(2,file='freqs3D.txt')
open(3,file='datos3D.txt')
...
! Calcular las frecuencias de resonancia
write(3,*) "Frecuencias de resonancia:" !
do o=o_inicial, 6
do p=p_inicial, 6
do q=q_inicial, 6
freq=0.5*sqrt((o/(imax*Dx))**2+(p/(jmax*Dy))**2+(q/(kmax*Dz))**2)/sqrt(mu*epsilon)
write(3, '(A,1PE12.4,A,I1,A,I1,A,I1,A)') ' frec:', freq,'Hz.   Con (l, m, n)= (', o, ', ', p, ', ', q, ')'
if ((o /= 0 .and. p /= 0) .or. (o /= 0 .and. q /= 0) .or. (p /= 0 .and. q /= 0)) then
!if (o /= 0 .and. p /= 0) then  !Esta es la condicion de teoria pero faltan frecuencias
    write(2,*) o, p, q, freq
end if
end do
end do
...
!Excitamos con un impuilso unitario todas las lineas
...
write(1, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt, &  !Para no perder precision usar formato cientifico
    Ex(Ox1, Oy1, Oz1), Ey(Ox1, Oy1, Oz1), Ez(Ox1, Oy1, Oz1), &
    Hx(Ox1, Oy1, Oz1), Hy(Ox1, Oy1, Oz1), Hz(Ox1, Oy1, Oz1)

!write(1, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt, &  
!    Ex(Ox1, Oy1, Oz1), Ey(Ox1, Oy1, Oz1), Ez(Ox1, Oy1, Oz1), &
!    Hx(Ox1, Oy1, Oz1), Hy(Ox1, Oy1, Oz1), Hz(Ox1, Oy1, Oz1), &
!    Ex(Ox2, Oy2, Oz2), Ey(Ox2, Oy2, Oz2), Ez(Ox2, Oy2, Oz2), &
!    Hx(Ox2, Oy2, Oz2), Hy(Ox2, Oy2, Oz2), Hz(Ox2, Oy2, Oz2), &
!    Ex(Ox3, Oy3, Oz3), Ey(Ox3, Oy3, Oz3), Ez(Ox3, Oy3, Oz3), &
!    Hx(Ox3, Oy3, Oz3), Hy(Ox3, Oy3, Oz3), Hz(Ox3, Oy3, Oz3)
