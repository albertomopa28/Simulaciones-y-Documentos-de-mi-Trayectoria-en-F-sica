...
parameter (imax= 1200, jmax= 1, kmax= 1)        !Dimensiones maximas de la red
Parameter (nits=3000)                           !Numero de iteraciones temporales
...
real :: long=0.001                              !Longitud de la lamina
real :: fmax = 250.0e9                          !Frecuencia máxima hasta la que queremos que no haya dispersion
real :: Dl=0.00004                              !Dimensiones en las que dividimos el espacio, escogido para que no haya dispersion hasta fmax
integer :: Inx=530, Iny=1, Inz=1               !Punto de excitacion
integer :: i_inter1=600, i_inter2=625         !Interseccion de ambos medios
!Puntos de salida:
integer :: Ox1=10, Oy1=1, Oz1=1               
integer :: Ox2=50, Oy2=1, Oz2=1               
integer :: Ox3=210, Oy3=1, Oz3=1  
integer :: Ox4=360, Oy4=1, Oz4=1       
            


    !RESTO DE VARIABLES 
real v2, Dt, Zo, Z1, Z2, Zx, Zy, Zz, Yx, Yy, Yz, Gx, Gy, Gz !unidad de tiempo y impedancias de los stubs
real hmin, g, g2, tm !Parametros del pulso gaussiano
...
open(1,file='salidas_multicapa.txt')
open(2,file='fteor.txt')
open(3,file='datos_multicapa.txt')
...
write(3, *) "epsilon0=", epsilon, " mu0=", mu, " c=", c
write(3, *)  " Mur1_3=", mur1, " epsilon_r1_3=", epsilon_r1, "Velocidad medio 1 y 3: v1=", c
write(3, *)  " Mur2=", mur2, " epsilon_r2=", epsilon_r2, "Velocidad medio 1: v2=", v2
write(3, *)  "Impedancia de la linea: Z0=", Zo
write(3, *) ""
write(3, *) "Parametros del sistema"
write(3, *) "Impedancia medio 1 y 3: Z1_3=", Z1, "Medio 2: Z2=", Z2
write(3, *) "Lamina de longitud: l=", long, "m, no hay reflexión en lambda_2/2=n*l,"
write(3, *) "con lambda_2=2*l=", 2*long, "y f=v2/lambda_2", v2/(2*long)/1.0e9, "GHz."
write(3, *) "En el medio 1: lambda_1=c/f=", c/(v2/(2*long))
...
write(3, *) ""
write(3, *) "Como queremos simular hasta fmax=", fmax, " empleamos Dl=v2/fmax=", v2/fmax, " =0.00004. Parametros del nudo:"
...
write(3, *) "Ox4=", Ox4, ", Oy4=", Oy4, ", Oz4=", Oz4
write(3, *) "Interseccion de los medios: i_inter1=", i_inter1, "i_inter2=", i_inter2
write(3, *) ""
...
E4=Ey1(Ox4, Oy4, Oz4)
H4=Hz1(Ox4, Oy4, Oz4)
write(1, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt, E1, H1, E2, H2, E3, H3, E4, H4 !Para no perder precision usar formato cientifico


do i=1, i_inter1
    write(11, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt,(i+1400)*Dx, Ey1(i,1,1), Hz1(i,1,1)
end do

do i=i_inter1+1, i_inter2
    write(11, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt,(i+1400)*Dx, Ey2(i,1,1), Hz2(i,1,1)
end do

do i=i_inter2+1, imax
    write(11, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt,(i+1400)*Dx, Ey1(i,1,1), Hz1(i,1,1)
end do
