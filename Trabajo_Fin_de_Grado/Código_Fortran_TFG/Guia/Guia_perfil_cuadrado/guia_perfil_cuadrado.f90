...
parameter (imax= 2000, jmax= 200, kmax= 1)       !Dimensiones maximas de la red
...
integer :: Inx=1000                  !Punto de excitacion
integer :: Ox1=1000, Oy1=100, Oz1=1                 
...
open(13,file='salidascuadrado.txt')
...
write(12, '(1x,i6,1x,e14.6,1x,2(e14.6,1x))') n, n*Dt, Ez(Ox1, Oy1, Oz1), Hy(Ox1, Oy1, Oz1)




do j = 1, jmax
    write(13, '(1x,i6,1x,e14.6,1x,e14.6,1x,e14.6,1x,e14.6)') n, n*Dt, j*Dy, Ez(Ox1, j, Oz1), Hy(Ox1, j, Oz1)
end do
...
do k=1,kmax
do j=1,jmax
V(6,Inx,j,k)=V(6,Inx,j,k)+vexc*sin(2*pi*fm*t)
end do
end do
