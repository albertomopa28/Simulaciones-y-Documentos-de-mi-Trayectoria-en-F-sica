...
parameter (imax= 600, jmax= 1, kmax= 1)         !Dimensiones maximas de la red
Parameter (nits=2000)                          !Numero de iteraciones temporales
real ::  epsilon=8.8541878128E-12, mu=1.25663706144E-6, c=2.99792458E8, mur=1., epsilon_r=8. !Ctes electromagneticas
...
integer :: Inx=300, Iny=1, Inz=1                 !Punto de excitacion
!Puntos de salida:
integer :: Ox1=51, Oy1=1, Oz1=1               
integer :: Ox2=50, Oy2=1, Oz2=1               
integer :: Ox3=50, Oy3=1, Oz3=1               
integer :: Ox4=40, Oy4=1, Oz4=1 
...
open(1,file='salidasdispersion.txt')
open(3,file='datosdispersion.txt')
...
write(3, *) "Dx=", Dx, " Dy=", Dy, " Dz=", Dz, " Dt=Dl/4c", Dt
write(3, *) ""
...
v2=1/sqrt(mur*mu*epsilon_r*epsilon)
...
E4=sqrt(Ex(Ox4, Oy4, Oz4)**2+Ey(Ox4, Oy4, Oz4)**2+Ez(Ox4, Oy3, Oz3)**2)
H4=sqrt(Hx(Ox4, Oy3, Oz3)**2+Hy(Ox4, Oy3, Oz3)**2+Hz(Ox3, Oy3, Oz3)**2)
write(1, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt, E1, H1, E2, H2, E3, H3, E4 , H4 !Para no perder precision usar formato cientifico


do i=1, imax
    write(11, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt,i*Dx, Ey(i,1,1), Hz(i,1,1)
end do
