...
parameter (imax= 50, jmax= 1, kmax= 1)         !Dimensiones maximas de la red
Parameter (nits=450)                          !Numero de iteraciones temporales
...
integer :: Inx=20, Iny=1, Inz=1                 !Punto de excitacion
!Puntos de salida:
integer :: Ox1=50, Oy1=1, Oz1=1               
integer :: Ox2=100, Oy2=1, Oz2=1               
...
open(1,file='salidas_unidireccional.txt')
open(3,file='datos_unidireccional.txt')
...
write(1, '(1x,i6,1x,e14.6,1x,18(e14.6,1x))') n, n*Dt, E1, H1, E2, H2 !Para no perder precision usar formato cientifico
