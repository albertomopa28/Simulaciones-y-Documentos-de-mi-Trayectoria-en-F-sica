...
speed_factor = 3.5;                  % Factor de velocidad del video
...
video_EH = VideoWriter('evolucion_EH_lam1.avi');
...
i_1 = 2000; % Primer índice
i_2 = 2025; % Segundo índice
Delta_x = x_vals(2) - x_vals(1); % Espaciado en x
x_vertical1 = i_1 * Delta_x; % Posición de la primera línea vertical
x_vertical2 = i_2 * Delta_x; % Posición de la segunda línea vertical
...
for i = 1:frame_step:length(unique_iters)
    ...
    plot(x, E, 'b'); % Campo E
    hold on;
    plot([x_vertical1, x_vertical1], [-E_max, E_max], 'k--', 'LineWidth', 0.5); % Primera línea vertical negra
    plot([x_vertical2, x_vertical2], [-E_max, E_max], 'k--', 'LineWidth', 0.5); % Segunda línea vertical negra
    hold off;
    ...
    plot(x, H, 'r'); % Campo H
    hold on;
    plot([x_vertical1, x_vertical1], [-H_max, H_max], 'k--', 'LineWidth', 0.5); % Primera línea vertical negra
    plot([x_vertical2, x_vertical2], [-H_max, H_max], 'k--', 'LineWidth', 0.5); % Segunda línea vertical negra
    hold off;
