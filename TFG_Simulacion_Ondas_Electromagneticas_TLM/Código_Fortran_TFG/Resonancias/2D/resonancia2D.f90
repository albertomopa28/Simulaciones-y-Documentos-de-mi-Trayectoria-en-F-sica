...
parameter (imax= 20, jmax= 30, kmax= 1)         !Dimensiones maximas de la red
Parameter (nits=1000000)                          !Numero de iteraciones temporales
...
integer :: Inx=7, Iny=13, Inz=1                  !Punto de excitacion
integer :: Ox1=19, Oy1=27, Oz1=1                  !Punto de salida
...
open(1,file='salidas2DTM.txt')
open(2,file='freqs2DTM.txt')
open(3,file='datos2D.txt')
...
V(lineafuente,Inx,Iny,Inz)=1. !Excitamos con una delta
...
do j=1,jmax
do k=1,kmax
V(3,1,j,k) = gammax*V(3,1,j,k)  
V(6,1,j,k) = gammax*V(6,1,j,k)  
V(10,imax,j,k) = gammax*V(10,imax,j,k)  
V(11,imax,j,k) = gammax*V(11,imax,j,k)  
end do
end do
